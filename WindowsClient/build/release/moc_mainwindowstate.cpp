/****************************************************************************
** Meta object code from reading C++ file 'mainwindowstate.h'
**
...
#error "The header file 'mainwindowstate.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MainWindowState_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MainWindowState_t qt_meta_stringdata_MainWindowState = {
    {
QT_MOC_LITERAL(0, 15) // "MainWindowState"
...
const QMetaObject MainWindowState::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MainWindowState.offsetsAndSize,
    qt_meta_data_MainWindowState,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MainWindowState_t
, QtPrivate::TypeAndForceComplete<MainWindowState, std::true_type>
